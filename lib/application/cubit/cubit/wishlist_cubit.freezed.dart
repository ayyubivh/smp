...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<ProductModel> wishlist) : _wishlist = wishlist;
...
abstract class _Loaded implements WishlistState {
  const factory _Loaded(final List<ProductModel> wishlist) = _$LoadedImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'WishlistState.error(failure: $failure)';
  }
